...
import v2.resources.web.course as course
import v2.resources.web.game as game
import v2.resources.web.session_game as session_game
...
def create_course():
    return course.create_course(request.get_json())
