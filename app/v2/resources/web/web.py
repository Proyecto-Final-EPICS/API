...
def get_school_course(id_school, code_course):
    return course.get_school_course(id_school, code_course)
...
@app.route('/school/<id_school>/course/<code_course>/game/<game_code>', methods=['PUT'])
